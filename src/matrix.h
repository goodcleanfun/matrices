...
#define MATRIX_INIT(name, type, type_name, array_type)                                                          \
    ...
    static inline void name##_set_row(name##_t *self, size_t index, type *row) {                                \
        ...
        memcpy(values + offset, row, n * sizeof(type));                                                         \
                                                                                                                ...
                                                                                                                \
    static inline void name##_set_at_index(name##_t *self, size_t row_index, size_t col_index, type value) {    \
        size_t offset = row_index * self->n + col_index;                                                        \
        self->values[offset] = value;                                                                           \
    }                                                                                                           \
                                                                                                                \
    static inline void name##_add_at_index(name##_t *self, size_t row_index, size_t col_index, type value) {    \
        size_t offset = row_index * self->n + col_index;                                                        \
        self->values[offset] += value;                                                                          \
    }                                                                                                           \
                                                                                                                \
    static inline void name##_sub_at_index(name##_t *self, size_t row_index, size_t col_index, type value) {    \
        size_t offset = row_index * self->n + col_index;                                                        \
        self->values[offset] -= value;                                                                          \
    }                                                                                                           \
                                                                                                                \
    static inline void name##_mul_at_index(name##_t *self, size_t row_index, size_t col_index, type value) {      \
        size_t offset = row_index * self->n + col_index;                                                        \
        self->values[offset] *= value;                                                                          \
    }                                                                                                           \
                                                                                                                \
    static inline void name##_div_at_index(name##_t *self, size_t row_index, size_t col_index, type value) {    \
        size_t offset = row_index * self->n + col_index;                                                        \
        self->values[offset] /= value;                                                                          \
    }                                                                                                           \
                                                                                                                \
    ...
    static inline bool name##_div_matrix(name##_t *self, name##_t *other) {                                     \
        ...
        return true;                                                                                            \
                                                                                                                ...
                                                                                                                \
    static inline bool name##_div_matrix_scaled(name##_t *self, name##_t *other, type v) {                      \
        if (self->m != other->m || self->n != other->n) return false;                                           \
        array_type##_div_array_scaled(self->values, other->values, v, self->m * self->n);                       \
        return true;                                                                                            \
    }                                                                                                           \
                                                                                                                \
    ...
    static inline bool name##_mul_matrix(name##_t *self, name##_t *other) {                                     \
        ...
        return true;                                                                                            \
                                                                                                                ...
                                                                                                                \
    static inline bool name##_mul_matrix_scaled(name##_t *self, name##_t *other, type v) {                      \
        if (self->m != other->m || self->n != other->n) return false;                                           \
        array_type##_mul_array_scaled(self->values, other->values, v, self->m * self->n);                       \
        return true;                                                                                            \
    }                                                                                                           \
                                                                                                                \
    ...
    static inline bool name##_add_matrix(name##_t *self, name##_t *other) {                                     \
        ...
        return true;                                                                                            \
                                                                                                                ...
                                                                                                                \
    static inline bool name##_add_matrix_scaled(name##_t *self, name##_t *other, type v) {                      \
        if (self->m != other->m || self->n != other->n) return false;                                           \
        array_type##_add_array_scaled(self->values, other->values, v, self->m * self->n);                       \
        return true;                                                                                            \
    }                                                                                                           \
                                                                                                                \
    ...
    static inline bool name##_sub_matrix(name##_t *self, name##_t *other) {                                     \
        ...
        return true;                                                                                            \
                                                                                                                ...
                                                                                                                \
    static inline bool name##_sub_matrix_scaled(name##_t *self, name##_t *other, type v) {                      \
        if (self->m != other->m || self->n != other->n) return false;                                           \
        array_type##_sub_array_scaled(self->values, other->values, v, self->m * self->n);                       \
        return true;                                                                                            \
    }                                                                                                           \
                                                                                                                \
...
#ifdef HAVE_CBLAS
#define MATRIX_INIT_FLOAT(name, type, type_name, array_type, precision)                                     \
    ...
    static inline bool name##_dot_matrix(name##_t *m1, name##_t *m2, name##_t *result) {                    \
        if (m1->n != m2->m || m1->m != result->m || m2->n != result->n) {                                   \
            return false;                                                                                   \
                                                                                                            ...
                                                                                                            \
        cblas_##precision##gemm(CblasRowMajor, CblasNoTrans, CblasNoTrans,                                  \
                    m1->m, m2->n, m1->n, 1.0,                                                               \
                    m1->values, m1->n,                                                                      \
                    m2->values, m2->n, 0.0,                                                                 \
